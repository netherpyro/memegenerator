...
class _RocketAnimationBodyState extends State<RocketAnimationBody>
  ...
  void initState() {
    super.initState();
    controller =
        AnimationController(vsync: this, duration: Duration(seconds: animationDurationSeconds));
    ...
    fireRotationAnimation = TweenSequence([
      TweenSequenceItem(tween: Tween<double>(begin: 0.005, end: -0.005), weight: 50),
      TweenSequenceItem(tween: Tween<double>(begin: -0.005, end: 0.005), weight: 50),
    ]).animate(
      CurvedAnimation(
        parent: controller,
        curve: Interval(0.0, 0.8, curve: SawTooth(animationDurationSeconds * 5)),
      ),
    );
          ...
          children: [
            Align(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  borderRadius:
                      BorderRadius.vertical(top: Radius.elliptical(snapshot.maxWidth, 200)),
